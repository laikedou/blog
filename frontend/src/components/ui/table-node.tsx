...
function TableFloatingToolbarContent({
  ...
  return (
    ...
    >
      ...
      >
        <ToolbarGroup>
          <ColorDropdownMenu tooltip={t("editor.backgroundColor")}>
            <PaintBucketIcon />
          </ColorDropdownMenu>
          {canMerge && onMerge && (
            <ToolbarButton
          ...
          <DropdownMenu modal={false}>
            <DropdownMenuTrigger asChild>
              <ToolbarButton tooltip={t("editor.cellBorders")}>
                <Grid2X2Icon />
              </ToolbarButton>
            </DropdownMenuTrigger>
          ...
          {collapsedInside && (
            <ToolbarGroup>
              <ToolbarButton tooltip={t("editor.deleteTable")} {...buttonProps}>
                <Trash2Icon />
              </ToolbarButton>
            </ToolbarGroup>
          )}
        ...
        {collapsedInside && (
          <ToolbarGroup>
            <ToolbarButton
              ...
              onMouseDown={(e) => e.preventDefault()}
              tooltip={t("editor.insertRowBefore")}
            >
              <ArrowUp />
            </ToolbarButton>
            <ToolbarButton
              ...
              onMouseDown={(e) => e.preventDefault()}
              tooltip={t("editor.insertRowAfter")}
            >
              <ArrowDown />
            </ToolbarButton>
            <ToolbarButton
        ...
        {collapsedInside && (
          <ToolbarGroup>
            <ToolbarButton
              ...
              onMouseDown={(e) => e.preventDefault()}
              tooltip={t("editor.insertColumnBefore")}
            >
              <ArrowLeft />
            </ToolbarButton>
            <ToolbarButton
              ...
              onMouseDown={(e) => e.preventDefault()}
              tooltip={t("editor.insertColumnAfter")}
            >
              <ArrowRight />
            </ToolbarButton>
            <ToolbarButton
  ...
  return (
    ...
    >
      ...
      <DropdownMenuGroup>
        ...
        >
          <BorderAllIcon />
          <div>{t("editor.outsideBorders")}</div>
        </DropdownMenuCheckboxItem>
      </DropdownMenuGroup>
    </DropdownMenuContent>
  );
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen} modal={false}>
      ...
      <DropdownMenuContent align="start">
        <ToolbarMenuGroup label={t("editor.colors")}>
          <ColorDropdownMenuItems
            className="px-2"
